...
var api = __webpack_require__(/*! ../../style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
            var content = __webpack_require__(/*! !../../css-loader/dist/cjs.js!./Chart.css */ "./node_modules/css-loader/dist/cjs.js!./node_modules/chart.js/dist/Chart.css");
...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/chart.js/dist/Chart.css":
/*!************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/chart.js/dist/Chart.css ***!
  \************************************************************************************/
/*! no static exports found */
...
/* harmony import */ var chart_js_dist_Chart_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! chart.js/dist/Chart.css */ "./node_modules/chart.js/dist/Chart.css");
/* harmony import */ var chart_js_dist_Chart_css__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(chart_js_dist_Chart_css__WEBPACK_IMPORTED_MODULE_4__);
...
/* harmony import */ var flatpickr_dist_themes_light_css__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! flatpickr/dist/themes/light.css */ "./node_modules/flatpickr/dist/themes/light.css");
/* harmony import */ var flatpickr_dist_themes_light_css__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(flatpickr_dist_themes_light_css__WEBPACK_IMPORTED_MODULE_8__);
...
const createPlaceholder = (dateFrom, dateTo) => {
  const format = (date) => moment__WEBPACK_IMPORTED_MODULE_2___default()(date).format(`DD MMM`);
...
const renderColorsChart = (colorsCtx, tasks) => {
  ...
  return new chart_js__WEBPACK_IMPORTED_MODULE_3___default.a(colorsCtx, {
...
const renderDaysChart = (daysCtx, tasks, dateFrom, dateTo) => {
  ...
  const taskCountOnDay = days.map((date) =>
    tasks.filter((task) => Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["isOneDay"])(task.dueDate, date)).length
  );

  const formattedDates = days.map((it) => moment__WEBPACK_IMPORTED_MODULE_2___default()(it).format(`DD MMM`));

  return new chart_js__WEBPACK_IMPORTED_MODULE_3___default.a(daysCtx, {
    plugins: [chartjs_plugin_datalabels__WEBPACK_IMPORTED_MODULE_5___default.a],
    type: `line`,
    data: {
...
const renderTagsChart = (tagsCtx, tasks) => {
  ...
  return new chart_js__WEBPACK_IMPORTED_MODULE_3___default.a(tagsCtx, {
    plugins: [chartjs_plugin_datalabels__WEBPACK_IMPORTED_MODULE_5___default.a],
    type: `pie`,
    data: {
      labels: tagsLabels,
...
class Statistics extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _applyFlatpickr(element) {
    ...
    this._flatpickr = flatpickr__WEBPACK_IMPORTED_MODULE_6___default()(element, {
      altInput: true,
      allowInput: true,
...
const createTaskEditTemplate = (task, options = {}) => {
  ...
  const description = he__WEBPACK_IMPORTED_MODULE_3___default.a.encode(currentDescription);
  ...
  const date = (isDateShowing && dueDate) ? Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_6__["formatDate"])(dueDate) : ``;
  const time = (isDateShowing && dueDate) ? Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_6__["formatTime"])(dueDate) : ``;

  const repeatClass = isRepeatingTask ? `card--repeat` : ``;
  const deadlineClass = isExpired ? `card--deadline` : ``;

  const repeatingDaysMarkup = createRepeatinDaysMarkup(_const_js__WEBPACK_IMPORTED_MODULE_5__["DAYS"], activeRepeatingDays, id);
  const tagsMarkup = createHashtagsMarkup(tags);
  const colorsMarkup = createColorsMarkup(_const_js__WEBPACK_IMPORTED_MODULE_5__["COLORS"], color, id);
...
class TaskEdit extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_4__["default"] {
  constructor(task) {
    super();
  ...
  _applyFlatpickr() {
    ...
    if (this._isDateShowing) {
      ...
      this._flatpickr = flatpickr__WEBPACK_IMPORTED_MODULE_0___default()(dateElement, {
        altInput: true,
        allowInput: true,
...
const createTaskTemplate = (task) => {
  ...
  const date = isDateShowing ? Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_2__["formatDate"])(dueDate) : ``;
  const time = isDateShowing ? Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_2__["formatTime"])(dueDate) : ``;
  const description = he__WEBPACK_IMPORTED_MODULE_0___default.a.encode(notSanitizedDescription);
...
/* harmony import */ var _components_no_tasks_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/no-tasks.js */ "./src/components/no-tasks.js");
/* harmony import */ var _components_load_more_button_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/load-more-button.js */ "./src/components/load-more-button.js");
/* harmony import */ var _task_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./task.js */ "./src/controllers/task.js");
...
const renderTasks = (taskListElement, tasks, onDataChange, onViewChange) =>
  tasks.map((task) => {
    const taskController = new _task_js__WEBPACK_IMPORTED_MODULE_4__["default"](taskListElement, onDataChange, onViewChange);
...
class BoardController {
  constructor(container, tasksModel, api) {
    ...
    this._noTasksComponent = new _components_no_tasks_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
    ...
    this._loadMoreButtonComponent = new _components_load_more_button_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
  ...
  render() {
    ...
    if (isAllTasksArchived) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(container, this._noTasksComponent);
      return;
    }

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(container, this._sortComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(container, this._tasksComponent);
  ...
  createTask() {
    ...
    this._creatingTask = new _task_js__WEBPACK_IMPORTED_MODULE_4__["default"](taskListElement, this._onDataChange, this._onViewChange);
    this._creatingTask.render(_task_js__WEBPACK_IMPORTED_MODULE_4__["EmptyTask"], `adding`);
  }
  ...
  _onDataChange(taskController, oldData, newData) {
    if (oldData === _task_js__WEBPACK_IMPORTED_MODULE_4__["EmptyTask"]) {
      this._creatingTask = null;
      if (newData === null) {
...
class FilterController {
  ...
  render() {
    ...
    const filters = FILTER_NAMES.map((filterType) => ({
      name: filterType,
      count: Object(_utils_filter_js__WEBPACK_IMPORTED_MODULE_2__["getTasksByFilter"])(allTasks, filterType).length,
    ...
    if (oldComponent) {
      ...
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(container, this._filterComponent);
    }
  }
...
/*!*********************************!*\
  !*** ./src/controllers/task.js ***!
  \*********************************/
/*! exports provided: default, EmptyTask */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
    ...
    switch (mode) {
      case `default`:
        if (oldTaskEditComponent && oldTaskComponent) {
          ...
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["render"])(this._container, this._taskComponent);
        }
        break;
      case `adding`:
        if (oldTaskEditComponent && oldTaskComponent) {
        ...
        Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["render"])(this._container, this._taskEditComponent, `afterbegin`);
        break;
    }
  }
...
/* harmony import */ var _components_statistics__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/statistics */ "./src/components/statistics.js");
/* harmony import */ var _controllers_board_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./controllers/board.js */ "./src/controllers/board.js");
...
/* harmony import */ var _models_tasks_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./models/tasks.js */ "./src/models/tasks.js");
...
const tasksModel = new _models_tasks_js__WEBPACK_IMPORTED_MODULE_5__["default"]();

const siteMainElement = document.querySelector(`.main`);
const siteHeaderElement = siteMainElement.querySelector(`.main__control`);
const siteMenuComponent = new _components_site_menu_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
const statisticsComponent = new _components_statistics__WEBPACK_IMPORTED_MODULE_2__["default"]({tasks: tasksModel, dateFrom, dateTo});

const boardComponent = new _components_board_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
const boardController = new _controllers_board_js__WEBPACK_IMPORTED_MODULE_3__["default"](boardComponent, tasksModel, api);
const filterController = new _controllers_filter_js__WEBPACK_IMPORTED_MODULE_4__["default"](siteMainElement, tasksModel);

Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_7__["render"])(siteHeaderElement, siteMenuComponent);
...
siteMenuComponent.setOnChange((menuItem) => {
  switch (menuItem) {
    case _components_site_menu_js__WEBPACK_IMPORTED_MODULE_0__["MenuItem"].NEW_TASK:
      siteMenuComponent.setActiveItem(_components_site_menu_js__WEBPACK_IMPORTED_MODULE_0__["MenuItem"].TASKS);
      statisticsComponent.hide();
      boardController.show();
      boardController.createTask();
      break;
    case _components_site_menu_js__WEBPACK_IMPORTED_MODULE_0__["MenuItem"].STATISTICS:
      boardController.hide();
      statisticsComponent.show();
      break;
    case _components_site_menu_js__WEBPACK_IMPORTED_MODULE_0__["MenuItem"].TASKS:
      statisticsComponent.hide();
      boardController.show();
      break;
  }
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: getRandomBoolean, getRandomIntegerNumber, getRandomArrayItem, shuffle, formatTime, formatDate, isRepeating, isOneDay, isOverdueDate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const formatTime = (date) =>
  moment__WEBPACK_IMPORTED_MODULE_0___default()(date).format(`hh:mm A`);

const formatDate = (date) =>
  moment__WEBPACK_IMPORTED_MODULE_0___default()(date).format(`DD MMMM`);
...
/*!*****************************!*\
  !*** ./src/utils/filter.js ***!
  \*****************************/
/*! exports provided: getArchiveTasks, getNotArchiveTasks, getFavoriteTasks, getOverdueTasks, getRepeatingTasks, getTasksWithHashtags, getTasksInOneDay, getTasksByFilter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getTasksWithHashtags", function() { return getTasksWithHashtags; });
...
const getRepeatingTasks = (tasks) => tasks.filter((task) => Object(_common_js__WEBPACK_IMPORTED_MODULE_0__["isRepeating"])(task.repeatingDays));

const getTasksWithHashtags = (tasks) => tasks.filter((task) => task.tags.size);

const getTasksInOneDay = (tasks, date) => tasks.filter((task) => Object(_common_js__WEBPACK_IMPORTED_MODULE_0__["isOneDay"])(task.dueDate, date));
